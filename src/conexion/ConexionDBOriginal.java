...
cn = DriverManager.getConnection("jdbc:mysql://"+cargaConfig()+"/central?useSSL=false&useTimezone=true&serverTimezone=UTC","prueba","passo12345");//0ehn4TNU5I +cargaConfig()+

...
cn = DriverManager.getConnection("jdbc:mysql://"+cargaConfig()+"/central?allowPublicKeyRetrieval=true&useSSL=false&useTimezone=true&serverTimezone=UTC","prueba","passo12345");//prueba,,0ehn4TNU5I +cargaConfig()+

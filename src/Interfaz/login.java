...
import Interfaz.internos.jpanels.clientes;
import Controller.datesControl;
...
public class login extends javax.swing.JFrame {
 ...
 String[] arrTurns = null; //arreglo para obtener datos de turno usuario activo
    ...
    private void initComponents() {
        ...
        jButton13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/clients.png"))); // NOI18N
...
//comentar descomentar linea para guardar el turno
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
            func1.limpiar(jPanTrabajo);
            clientA = new clientes();
            jPanTrabajo.setLayout(new GridLayout(1,1));
            jPanTrabajo.add(clientA);
            jPanTrabajo.validate();
            jPanTrabajo.setVisible(true);
            jPanTrabajo.setEnabled(true);  
